...
public class XPick extends TPick implements IRelode, IMode {

	public XPick(String name, ToolMaterial material) {
		super(name, material);
	}
	...
	public boolean onBlockDestroyed(ItemStack stack, World world, IBlockState state, BlockPos pos, EntityLivingBase living) {
		...
		BaseRangeBreak.xToolBreak(stack, world, state, pos, player, sideHit, tags, 0);

...
public class XAxe extends TAxe implements IRelode, IMode {

	public XAxe(String name, ToolMaterial material, float damage, float speed) {
	...
	public boolean onBlockDestroyed(ItemStack stack, World world, IBlockState state, BlockPos pos, EntityLivingBase living) {
		...
		BaseRangeBreak.xToolBreak(stack, world, state, pos, player, sideHit, tags, 2);

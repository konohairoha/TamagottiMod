...
public class RubyPick extends TPick {

	public RubyPick(String name, ToolMaterial material) {
		super(name, material);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
  		...
  		tooltip.add(I18n.format(TextFormatting.GOLD + "" + range + "×" + (area + 1)  + "×" + range + "に焼き石で埋める"));
    }
}
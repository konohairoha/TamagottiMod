...
import tamagotti.init.entity.layer.LayerLCEvokerDep;

@SideOnly(Side.CLIENT)
public class RenderLCEvokerDep extends RenderLiving<EntityMob> {

	private static final ResourceLocation TEX = new ResourceLocation("tamagottimod:textures/entity/tevokerdep.png");

	public RenderLCEvokerDep(RenderManager render) {
		super(render, new ModelIllager(0.0F, 0.0F, 64, 64), 0.5F);
        this.addLayer(new LayerLCEvokerDep(this));

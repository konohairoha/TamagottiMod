...
public class TileSWChest extends TileBaseChest {
	...
	public SPacketUpdateTileEntity getUpdatePacket() {
		...
		return new SPacketUpdateTileEntity(this.pos, -50, nbtTagCompound);
	}
	...
	public void openInventory(EntityPlayer player) {
		if(!this.world.isRemote) {
			this.world.playSound(null, this.pos, TSoundEvent.KIDO, SoundCategory.BLOCKS, 0.25F, 1.0F);
		}
    }
}

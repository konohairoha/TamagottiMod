...
public class SakuraSlab extends Block {
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        return state.getValue(HALF).equals(EnumBlockTofuSlab.FULL) ? state : (facing != EnumFacing.DOWN && (facing == EnumFacing.UP || hitY <= 0.5D) ? state.withProperty(HALF, EnumBlockTofuSlab.BOTTOM) : state.withProperty(HALF, EnumBlockTofuSlab.TOP));
    }

...
public class GuiTFelling extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("tamagottimod", "textures/gui/gui_tharvesterpng.png");
	private final TileTFelling tile;

	public GuiTFelling(InventoryPlayer invPlayer, TileTFelling tile) {
		super(new ContainerTFelling(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 200;
		this.tile = tile;
	}

...
public class GuiTDisplay extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("tamagottimod", "textures/gui/gui_tdispaly.png");
	private final TileTDisplay tile;

	public GuiTDisplay(InventoryPlayer invPlayer, TileTDisplay tile) {
		super(new ContainerTDisplay(invPlayer, tile));
		this.xSize = 209;
		this.ySize = 165;
		this.tile = tile;
	}

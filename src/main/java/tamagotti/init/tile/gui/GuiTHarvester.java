...
public class GuiTHarvester extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("tamagottimod", "textures/gui/gui_tharvesterpng.png");
	private final TileTHarvester tile;

	public GuiTHarvester(InventoryPlayer invPlayer, TileTHarvester tile) {
		super(new ContainerTHarvester(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 200;
		this.tile = tile;
	}

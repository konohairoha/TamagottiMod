...
public class GuiTPlanter extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation("tamagottimod", "textures/gui/gui_tharvesterpng.png");
	private final TileTPlanter tile;

	public GuiTPlanter(InventoryPlayer invPlayer, TileTPlanter tile) {
		super(new ContainerTPlanter(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 200;
		this.tile = tile;
	}

...
public class GuiDFurnace extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation("tamagottimod", "textures/gui/gui_tstove.png");
	private final TileDFurnace tile;

	public GuiDFurnace(InventoryPlayer invPlayer, TileDFurnace tile) {
		super(new ContainerDFurnace(invPlayer, tile));
		this.xSize = 209;
		this.ySize = 255;
		this.tile = tile;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		if (tile.isBurning()) {
			...
			this.drawTexturedModalRect(x + 66, y + 83 + 10 - progress, 210, 10 - progress, 21, progress + 2);
		}
